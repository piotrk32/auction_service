...
//        @Pattern(regexp = PRICE_REGEX, message = "Item price must contain only numbers and , or . .")
...
//        @NotNull(message = "Buy now price cannot be empty if buy now is active.")
//        @Min(value = 0, message = "Buy Now price must not be less than or equal to zero.")
//        @Pattern(regexp = PRICE_REGEX, message = "Buy now price must contain only numbers and , or . .")
